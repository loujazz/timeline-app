...
const SheetIcon = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h8"/><path d="M8 17h8"/><path d="M10 9H8"/></svg>;
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "28px 20px 80px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        {/* ===== IMPORT CSV & NOTEBOOK LM ===== */}
        <Section icon={<SheetIcon />} title="Importazione Massiva (CSV & NotebookLM)">
          <P>
            Puoi aggiungere decine di eventi contemporaneamente caricando un file <strong>CSV</strong>.
            Questa funzione è ideale per trasformare documenti complessi o libri in timeline in pochi secondi.
          </P>

          <H>Formattazione del file CSV</H>
          <P>Il file deve essere una tabella semplice con esattamente queste tre colonne:</P>
          <ul style={{ paddingLeft: 18, margin: "0 0 10px" }}>
            <Li><strong>Data</strong> &mdash; in formato <Code>GG/MM/AAAA</Code> (es. 25/12/2024).</Li>
            <Li><strong>Titolo</strong> &mdash; un nome breve per l&apos;evento (massimo 5 parole).</Li>
            <Li><strong>Descrizione</strong> &mdash; i dettagli dell&apos;evento (massimo 20 parole).</Li>
          </ul>

          <H>Generare la timeline con NotebookLM</H>
          <P>
            Puoi usare l&apos;IA di Google, <strong>NotebookLM</strong>, per estrarre automaticamente i dati dai tuoi documenti:
          </P>
          <ol style={{ paddingLeft: 18, margin: "0 0 10px" }}>
            <Li>Apri <strong>NotebookLM</strong> e seleziona il Notebook da cui vuoi generare la cronologia.</Li>
            ...
            <Li>Vai su <strong>File &rarr; Scarica &rarr; Valori separati da virgola (.csv)</strong>.</Li>
          </ol>
          <P>
            A questo punto il file è pronto per l&apos;upload nella tua timeline.
          </P>
        </Section>
