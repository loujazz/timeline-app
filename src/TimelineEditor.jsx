...
export default function TimelineEditor({ timeline, onUpdate, onBack }) {
  ...
  const headerColor = cardColor(timeline.id);
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--md-surface)", fontFamily: "var(--md-font)", color: "var(--md-on-surface)", display: "flex", flexDirection: "column" }}>

      {/* Colored header bar */}
      <div style={{
        background: headerColor, padding: "16px 32px",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: 20, fontWeight: 600, color: "#fff", textShadow: "0 1px 2px rgba(0,0,0,0.15)" }}>{timeline.name}</h1>
            <p style={{ margin: "2px 0 0", fontSize: 13, color: "rgba(255,255,255,0.8)" }}>{events.length} eventi</p>
          </div>
        </div>
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          {/* Layout toggle */}
          <div style={{ display: "flex", borderRadius: 9999, overflow: "hidden", background: "rgba(255,255,255,0.15)" }}>
        ...
        <div style={{ padding: "24px 32px", borderBottom: "1px solid var(--md-outline-variant)", background: "var(--md-surface-container-lowest)", animation: "fadeIn 0.3s ease-out" }}>
          <div style={{ maxWidth: 640 }}>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <textarea value={form.desc} onChange={e => setF("desc", e.target.value)} rows={2} placeholder="Descrizione opzionale..." style={{ ...inputSt, resize: "none" }} />
            </div>
