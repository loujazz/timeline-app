...
// Palette for card headers — softer pastello versions
const CARD_COLORS = [
  "#6366f1", "#ec4899", "#f59e0b", "#10b981",
  "#3b82f6", "#8b5cf6", "#ef4444", "#0ea5e9",
];

// Stable color for a timeline based on its id
                    ...
                    <div style={{ display: "flex", gap: 4, marginTop: 12 }}>
                      {tl.events.slice(0, 8).map((ev, i) => (
                        <div key={i} style={{
                          ...
                          background: ev.color || "var(--md-outline)",
                        }} />
                      ))}
                      {tl.events.length > 8 && (
