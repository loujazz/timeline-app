                ...
                <div style={{ position: "absolute", top: 10, right: 10 }} ref={menuOpen === tl.id ? menuRef : null}>
                  ...
                  {menuOpen === tl.id && (
                    <div style={{
                      ...
                      <button onClick={() => {
                        setMenuOpen(null);
                        const newName = prompt("Rinomina timeline:", tl.name);
                        if (newName && newName.trim()) onUpdate(tl.id, { name: newName.trim() });
                      }} style={{
                        width: "100%", padding: "10px 16px", border: "none", background: "transparent",
                        textAlign: "left", fontSize: 14, cursor: "pointer", color: "var(--md-on-surface)",
                        fontFamily: "var(--md-font)", display: "flex", alignItems: "center", gap: 10,
                        ...
                        onMouseLeave={e => e.currentTarget.style.background = "transparent"}
                      >
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 3a2.83 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>
                        Rinomina
                      </button>
